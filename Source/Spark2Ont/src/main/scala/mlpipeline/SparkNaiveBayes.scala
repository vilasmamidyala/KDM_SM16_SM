...
object SparkNaiveBayes {
  ...
  def main(args: Array[String]) {
    System.setProperty("hadoop.home.dir", "m:\\winutils")

    val trainFolder = "data/Categories/*"
    val conf = new SparkConf().setAppName(s"NBExample").setMaster("local[*]").set("spark.driver.memory", "12g").set("spark.executor.memory", "4g")
    ...
    val CATEGORIES = List("clinton", "trump")
    var index = 0
