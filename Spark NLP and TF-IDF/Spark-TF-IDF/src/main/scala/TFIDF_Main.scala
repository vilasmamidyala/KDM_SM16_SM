...
object TFIDF_Main {
  def main(args: Array[String]) {
    ...
    System.setProperty("hadoop.home.dir", "S:\\winutils");

    val sparkConf = new SparkConf().setAppName("SparkWordCount").setMaster("local[*]")

    val sc = new SparkContext(sparkConf)

    val documents = sc.textFile("K:\\New folder\\CS5560-T5-SourceCode\\CS5560 Tutorial 5 Source Code\\Spark-TF-IDF\\Article.txt")
